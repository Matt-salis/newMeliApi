...
class tokenService {
    refreshToken() {
      ...
      checkParam() {
        ...
        if (code == null) {
          return window.location.replace('https://auth.mercadolibre.com.ar/authorization?response_type=code&client_id=3301773768813163&redirect_uri=http://localhost:8090')
        } else {
          this.code = code
